    ...
    darkMode: function () {
        ...
        if (e.isVariableDefined(dark)) {
            ...
            dms.addEventListener("click", function(){
              if(dir == 'rtl') {
                  if (style.getAttribute('href') == 'news/assets/css/style-rtl.css') {
                      style.setAttribute('href', 'news/assets/css/style-dark-rtl.css');    
                  }
                  else {
                      style.setAttribute('href', 'news/assets/css/style-rtl.css');  
                  } 
                } 
                else {
                    if (style.getAttribute('href') == 'news/assets/css/style.css') {
                        style.setAttribute('href', 'news/assets/css/style-dark.css');    
                    }
                    else {
                        style.setAttribute('href', 'news/assets/css/style.css');  
                    }
                }
